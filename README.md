...
- [Plan File Policy](guides/plan-file-policy.md) — Hard triggers for when to open a `.claude/plans/` plan file, plus a SessionStart resume hook for unfinished plans
